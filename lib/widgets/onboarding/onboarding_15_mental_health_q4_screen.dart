...
part 'onboarding_15_mental_health_q4_screen.g.dart';

@TypedGoRoute<Onboarding15MentalHealthQ4Route>(
  path: '/onboarding/15_mental_health_q4',
)
class Onboarding15MentalHealthQ4Route extends GoRouteData {
  const Onboarding15MentalHealthQ4Route();

  @override
  Widget build(final BuildContext context, final GoRouterState state) =>
      const Onboarding15MentalHealthQ4Screen();
...
class Onboarding15MentalHealthQ4Screen extends HookConsumerWidget {
  /// The welcome screen of the onboarding flow.
  const Onboarding15MentalHealthQ4Screen({super.key});
  @override
  Widget build(final BuildContext context, final WidgetRef ref) {
    final MediaQueryData mediaQuery = MediaQuery.of(context);
    final ThemeData theme = Theme.of(context);

    final I18NOnboardingA15MentalHealthQ4EnUs i18n =
        I18N.of(context).onboarding.a15MentalHealthQ4;
    final $SourceAssetsOnboarding15MentalHealthQ4Gen assets =
        Assets.source.assets.onboarding.a15MentalHealthQ4;
      ...
      if (!isLoading.value) {
        ...
        try {
          await ref.read(analyticsProvider.notifier).track(
                BaseEvent(
                  'onboarding_screen_14_clicked',
                  eventProperties: <String, String>{
                    'ob_type': 'quiz_1',
                    'screen_type': 'meantheal4',
                    'answer': frequency.name,
                  },
                ),
              );
          final Onboarding onboarding = ref.read(onboardingProvider.notifier);
          await onboarding.setMentalHealthQ4Result(frequency);
          if (context.mounted) {
