...
part 'onboarding_09_motivation_q3_screen.g.dart';

@TypedGoRoute<Onboarding09MotivationQ3Route>(
  path: '/onboarding/09_motivation_q3',
)
class Onboarding09MotivationQ3Route extends GoRouteData {
  const Onboarding09MotivationQ3Route();

  @override
  Widget build(final BuildContext context, final GoRouterState state) =>
      const Onboarding09MotivationQ3Screen();
...
class Onboarding09MotivationQ3Screen extends HookConsumerWidget {
  /// The welcome screen of the onboarding flow.
  const Onboarding09MotivationQ3Screen({super.key});
  @override
  Widget build(final BuildContext context, final WidgetRef ref) {
    final MediaQueryData mediaQuery = MediaQuery.of(context);
    final ThemeData theme = Theme.of(context);

    final I18NOnboardingA09MotivationQ3EnUs i18n =
        I18N.of(context).onboarding.a09MotivationQ3;
    final $SourceAssetsOnboarding09MotivationQ3Gen assets =
        Assets.source.assets.onboarding.a09MotivationQ3;
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Positioned(
                    left: mediaQuery.size.width / 2 - 322 / 2 + 4,
                    top: 77.35 + 16,
                    child: SizedBox(
                      width: 322,
                      height: 319.31,
                  ...
                  Positioned(
                    left: mediaQuery.size.width / 2 - 322 / 2,
                    top: 77.35,
                    child: Container(
                      width: 322,
                      height: 319.31,
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: assets.girlreadingonastackofbooks1.provider(),
                          fit: BoxFit.contain,
                        ),
                      ),
                    ),
