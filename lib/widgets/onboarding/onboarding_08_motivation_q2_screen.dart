...
part 'onboarding_08_motivation_q2_screen.g.dart';

@TypedGoRoute<Onboarding08MotivationQ2Route>(
  path: '/onboarding/08_motivation_q2',
)
class Onboarding08MotivationQ2Route extends GoRouteData {
  const Onboarding08MotivationQ2Route();

  @override
  Widget build(final BuildContext context, final GoRouterState state) =>
      const Onboarding08MotivationQ2Screen();
...
class Onboarding08MotivationQ2Screen extends HookConsumerWidget {
  /// The welcome screen of the onboarding flow.
  const Onboarding08MotivationQ2Screen({super.key});
  @override
  Widget build(final BuildContext context, final WidgetRef ref) {
    final MediaQueryData mediaQuery = MediaQuery.of(context);
    final ThemeData theme = Theme.of(context);

    final I18NOnboardingA08MotivationQ2EnUs i18n =
        I18N.of(context).onboarding.a08MotivationQ2;
    final $SourceAssetsOnboarding08MotivationQ2Gen assets =
        Assets.source.assets.onboarding.a08MotivationQ2;
      ...
      if (!isLoading.value) {
        ...
        try {
          await ref
              ...
              .track(
                BaseEvent(
                  'onboarding_screen_7_clicked',
                  eventProperties: <String, String>{
                    'ob_type': 'quiz_1',
                    'screen_type': 'motivation2',
                    'answer': result ? 'yes' : 'no',
                  },
                ),
              );
          final Onboarding onboarding = ref.read(onboardingProvider.notifier);
          await onboarding.setMotivationQ2Result(result: result);
          if (context.mounted) {
                    ...
                    child: SizedBox(
                      ...
                      child: Opacity(
                        ...
                        child: ImageFiltered(
                          ...
                          child: assets.womanopeninglockwithakey2.image(
                            color: Colors.black,
                          ),
                        ),
                      ),
