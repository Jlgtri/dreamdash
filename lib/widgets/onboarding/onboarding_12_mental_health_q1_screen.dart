...
part 'onboarding_12_mental_health_q1_screen.g.dart';

@TypedGoRoute<Onboarding12MentalHealthQ1Route>(
  path: '/onboarding/12_mental_health_q1',
)
class Onboarding12MentalHealthQ1Route extends GoRouteData {
  const Onboarding12MentalHealthQ1Route();

  @override
  Widget build(final BuildContext context, final GoRouterState state) =>
      const Onboarding12MentalHealthQ1Screen();
...
class Onboarding12MentalHealthQ1Screen extends HookConsumerWidget {
  /// The welcome screen of the onboarding flow.
  const Onboarding12MentalHealthQ1Screen({super.key});
  @override
  Widget build(final BuildContext context, final WidgetRef ref) {
    final MediaQueryData mediaQuery = MediaQuery.of(context);
    final ThemeData theme = Theme.of(context);

    final I18NOnboardingA12MentalHealthQ1EnUs i18n =
        I18N.of(context).onboarding.a12MentalHealthQ1;
            ...
            child: Column(
              ...
              children: <Widget>[
                Text.rich(
                  TextSpan(
                    children: <InlineSpan>[
                      TextSpan(text: i18n.howOftenDoYou),
                      const TextSpan(text: ' '),
                      TextSpan(
