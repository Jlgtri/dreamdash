...
@TypedGoRoute<Onboarding29ChatRoute>(path: '/onboarding/29_chat')
  ...
  Widget build(final BuildContext context, final WidgetRef ref) {
    ...
    final SendMessageConfiguration sendMessageConfig =
        SendMessageConfiguration(
          ...
          defaultSendButtonColor: theme.colorScheme.onSurface.withValues(
            alpha: 0.2,
          ),
    ...
    return Theme(
      data: ThemeData(
        textSelectionTheme: TextSelectionThemeData(
          ...
          selectionHandleColor: theme.colorScheme.onSurface.withValues(
            alpha: 0.2,
          ),
        ),
      ),
      child: Container(
        ...
        child: ChatView(
          ...
          sendMessageBuilder:
              (final ReplyMessage? replyMessage) => SizedBox(
